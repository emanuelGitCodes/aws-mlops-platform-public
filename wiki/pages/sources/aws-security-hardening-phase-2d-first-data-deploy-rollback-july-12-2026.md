...
Before retrying Data, the repository must pass local gates, a scoped diff, a new
commit, and hosted CI. The already-deployed Security sink statement remains the
