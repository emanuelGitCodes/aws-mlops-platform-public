...
- The Processing job uploads `preprocess.py` without the repository package that
  holds `src.common.schema`. The packaging fix MUST keep one shared schema. It
  MUST NOT copy the schema.
